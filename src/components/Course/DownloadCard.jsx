...
const DownloadCard = ({title,description}) => {
  return (
    <div className='shadow-lg flex flex-grow flex-col justify-center p-8 rounded-xl hover:shadow-xl duration-200 min-h-[20rem]'>
    <div className='flex items-center justify-center gap-2 border-b-2 border-gray-400 pb-4 mb-4'>
            <h1 className='text-2xl lg:w-[70%] md:w-[78%] w-[90%]  text-center font-semibold text-text-head'>{title}</h1>
    </div>
