...
const DownloadCard = ({title,description}) => {
  return (
    <div className='shadow-lg flex flex-grow flex-col justify-center p-8 rounded-xl hover:shadow-xl duration-200 lg:max-w-[19rem] md:max-w-[25rem] max-w-[26rem] lg:mx-auto md:mx-0 mx-auto min-h-[20rem]'>
    <div className='flex items-center justify-center gap-2 border-b-2 border-gray-400 pb-4 mb-4'>
            <h1 className='lg:text-2xl text-xl lg:w-[82%] md:w-[70%] w-[90%]  text-center font-semibold text-text-head'>{title}</h1>
    </div>
