...
const BlogCard1 = ({id,image,title,description,date}) => {
  return (
    <div className='shadow-lg cursor-pointer border-2 w-[35rem] lg:flex-row flex-col flex-grow border-gray-300 flex items-start justify-start lg:px-5 lg:py-5 md:px-3 md:py-5 px-3 py-5 rounded-2xl hover:shadow-xl duration-200 lg:gap-8 md:gap-6 gap-4'>

        <div className='w-[25rem] h-full mb-8 flex items-start mx-auto'>
