...
const Hero = () => {
  return (
    ...
    <Container>
        ...
        <div className='w-[50%]'>
            <h1 className=' text-4xl text-text-head font-Alata font-semibold'>Achieve Excellence in JEE, MHT-CET, & 11th/12th grade physics with-Bhusawal’s leading academy.</h1>
